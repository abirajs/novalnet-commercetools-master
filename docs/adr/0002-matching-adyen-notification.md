# 2. Matching novalnet Notification with commercetools payment.

Date: 2020-12-18

## Status

[Deprecated](https://github.com/commercetools/commercetools-novalnet-integration/pull/395)
...
- The extension module will validate the reference field makePaymentRequest#reference before handling the payment to avoid unnecessary calls to novalnet.
...
Please refer to the [0011-matching-novalnet-notification](./0011-matching-novalnet-notification.md) for the latest change regarding matching Notification with payment.