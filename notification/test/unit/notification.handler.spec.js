...
import {
  overridenovalnetConfig,
  restorenovalnetConfig,
...
describe('notification module', () => {
  ...
  it(`given that novalnet sends an "AUTHORISATION is unsuccessful"`, async () => {
    // prepare data
    const notifications = [
      {
  ...
  it(`given that novalnet sends an "AUTHORISATION is successful" notification
  ...
  it(`given that novalnet sends an "AUTHORISATION is not successful" notification
  ...
  it(`given that novalnet sends a "CANCELLATION is successful" notification
      when payment has a pending authorization transaction 
      then notification module should add notification to the interface interaction 
  ...
  it(`given that novalnet sends a "CAPTURE is successful" notification
  ...
  it(`given that novalnet sends a "CAPTURE_FAILED notification"
      when payment has a successful authorization transaction 
      then notification module should add notification to the interface interaction 
      ...
      const notifications = [
        {
          NotificationRequestItem: {
            additionalData: {
              ...
              'metadata.commercetoolsProjectKey': 'novalnet-qa',
            ...
            merchantAccountCode: 'novalnet-ctp-qa-01',
