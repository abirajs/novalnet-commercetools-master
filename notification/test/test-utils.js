...
let originalGetnovalnetConfigFn

function overridenovalnetConfig(newnovalnetConfig) {
  originalGetnovalnetConfigFn = config.getnovalnetConfig
  config.getnovalnetConfig = () => newnovalnetConfig
}

function restorenovalnetConfig() {
  config.getnovalnetConfig = originalGetnovalnetConfigFn
}
...
function createNotificationPayload(
    ...
    notificationItems: [
      {
        NotificationRequestItem: {
          ...
          merchantAccountCode: novalnetMerchantAccount,
          merchantReference,
  ...
  if (novalnetConfig.enableHmacSignature) {
...
async function ensurePayment(
  ...
  paymentDraft.custom.fields.novalnetMerchantAccount = novalnetMerchantAccount
  if (pspReference) {
