...
/*
 * recoverable: notification delivery can be retried by novalnet (return 500)
 * non recoverable: notification delivery can not be retried by novalnet
 * as it most probably would fail again (return "accepted")
 *
 * If commercetools status code is defined and is 5xx then return `500` to novalnet -> recoverable
