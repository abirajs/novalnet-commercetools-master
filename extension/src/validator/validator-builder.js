...
function withPayment(paymentObject) {
  ...
  return {
    validateMetadataFields() {
      ...
      if (!isValidMetadata(paymentObject.custom.fields.novalnetMerchantAccount))
        errors.missingRequirednovalnetMerchantAcc =
          errorMessages.MISSING_REQUIRED_FIELDS_novalnet_MERCHANT_ACCOUNT
      return this
    },
