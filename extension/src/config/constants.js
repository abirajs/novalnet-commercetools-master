export default {
  CTP_novalnet_INTEGRATION: 'ctp-novalnet-integration',
  CTP_PAYMENT_INTERACTION_CUSTOM_TYPE_KEY:
    'ctp-novalnet-integration-interaction-payment-type',
  CTP_PAYMENT_CUSTOM_TYPE_KEY:
    'ctp-novalnet-integration-web-components-payment-type',
