...
// Flow description: https://docs.novalnet.com/payment-methods/klarna/web-component#page-introduction
describe('::klarnaPayment::', () => {
  ...
  it(`when payment session for klarna payment is created, initialized and ' + 
      ...
      'then novalnet should respond with [capture-received] and [refund-received] for each transaction respectively' +
    ...
    try {
      ...
      const clientKey = config.getnovalnetConfig(novalnetMerchantAccount).clientKey
