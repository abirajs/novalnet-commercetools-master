...
// Flow description: https://docs.novalnet.com/checkout/components-web
describe('::creditCardPayment::cancel-payment::', () => {
  ...
  // See more: https://docs.novalnet.com/development-resources/test-cards/test-card-number
  ...
  it(`when payment session for credit card is created, initialized and ' + 
      ...
      'then novalnet should respond with [cancel-received] for each transaction ' +
