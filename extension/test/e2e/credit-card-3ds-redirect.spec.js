...
// Flow description: https://docs.novalnet.com/checkout/3d-secure/redirect-3ds2-3ds1/web-component
// Skipped because novalnet test cards do not return redirect response anymore
describe.skip('::creditCardPayment3dsRedirect::', () => {
  ...
  // See more: https://docs.novalnet.com/development-resources/test-cards/test-card-numbers
  const creditCards = [
    {
      name: 'Mastercard',
      ...
      it(
        ...
        async () => {
          ...
          try {
            ...
            const clientKey =
              config.getnovalnetConfig(novalnetMerchantAccount).clientKey

            const browserTab = await browser.newPage()

            // Step #1 - Create a payment session
            // https://docs.novalnet.com/online-payments/web-components#create-payment-session
            ...
            // https://docs.novalnet.com/online-payments/web-components#set-up
            ...
            // https://docs.novalnet.com/online-payments/web-components#handle-redirect-result
  ...
  async function handleRedirect({ browserTab, baseUrl, clientKey }) {
    ...
    const submittedRedirectResult =
      await redirectPaymentFormPage.redirectTonovalnetPaymentPage(
        clientKey,
        sessionId,
        redirectResult,
      )
