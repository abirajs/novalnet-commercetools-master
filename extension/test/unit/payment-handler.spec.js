...
describe('payment-handler::execute', () => {
  ...
  it(
    'when "commercetoolsProjectKey" and "novalnetMerchantAccount" are missing, ' +
    ...
    async () => {
      ...
      expect(response.errors[1].message).to.equal(
        errorMessage.MISSING_REQUIRED_FIELDS_novalnet_MERCHANT_ACCOUNT,
      )
    },
  )
  ...
  describe('amountPlanned', () => {
    it(
      ...
      async () => {
        ...
        ctpPaymentClone.custom.fields.novalnetMerchantAccount =
