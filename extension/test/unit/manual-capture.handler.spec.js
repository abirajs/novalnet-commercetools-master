...
describe('manual-capture.handler::execute::', () => {
  ...
  beforeEach(() => {
    ...
    scope = nock(`${novalnetConfig.apiBaseUrl}/payments/8313547924770610/`)
  })

  it(
    'given a payment ' +
      'when "/capture" request to novalnet is received successfully ' +
    ...
    async () => {
      ...
      paymentObject.custom.fields.novalnetMerchantAccount = novalnetMerchantAccount
  ...
  it(
    'given a payment ' +
      'when "/capture" request to novalnet is failed ' +
  ...
  it(
    ...
    async () => {
      ...
      const novalnetRequest = actions.find(
