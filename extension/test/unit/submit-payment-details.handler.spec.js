...
import submitPaymentDetailsSuccessResponse from './fixtures/novalnet-submit-payment-details-success-response.js'
import submitPaymentDetailsChallengeRes from './fixtures/novalnet-submit-payment-details-challenge-shopper-response.js'
import makePaymentRedirectResponse from './fixtures/novalnet-make-payment-3ds-redirect-response.js'
...
describe('submit-additional-payment-details::execute', () => {
  ...
  it(
    'when resultCode from novalnet is "ChallengeShopper", ' +
