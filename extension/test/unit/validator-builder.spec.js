...
const {
  ...
  MISSING_REQUIRED_FIELDS_novalnet_MERCHANT_ACCOUNT,
...
describe('Validator builder', () => {
  ...
  it('on missing novalnetMerchantAccount in custom fields should return error object', () => {
    const invalidPayment = {
      custom: {
        fields: {
